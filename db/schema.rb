...
ActiveRecord::Schema[7.1].define(version: 2024_03_18_135727) do
  ...
  create_table "course_section_embeddings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.json "embedding"
    t.integer "order"
    t.uuid "course_section_id", null: false
    t.json "details"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_section_id"], name: "index_course_section_embeddings_on_course_section_id"
  end
